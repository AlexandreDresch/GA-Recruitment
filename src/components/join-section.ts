  ...
  render(): string {
    return `
      <section id="join-us">
        ...
        <p>Submit your data to be considered for recruitment by The City Administration. Only those with the necessary skills and qualifications will be contacted.</p>      
        
        <form class="w-full mx-auto mt-5" id="join-us-form">
          ...
          <div class="grid md:grid-cols-2 md:gap-6">
            <div class="relative z-0 w-full mb-5 group">
              ...
              <label for="floating_phone" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-red-600 peer-focus:dark:text-red-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Input Identifier Code</label>
            </div>
            <div class="relative z-0 w-full mb-5 group">
              <input type="text" name="floating_augmentation" id="floating_augmentation" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-red-500 focus:outline-none focus:ring-0 focus:border-red-600 peer" placeholder="" required />
              <label for="floating_augmentation" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-red-600 peer-focus:dark:text-red-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Physical Augmentation Log</label>
            </div>
          </div>
          <button type="submit" class="glitch-button" data-text="SUBMIT">Submit</button>
        </form>

        <div id="toast" class="hidden fixed z-50 top-5 left-1/2 transform -translate-x-1/2 bg-black text-white text-sm font-bold px-4 py-2 border border-white">
