...
export class JoinUsSection extends Component {
  render(): string {
    return /*html*/ `
      <section id="join-us">
        <h2 class="section-title" data-text="JOIN US">Join Us</h2>
        ...
        <form class="form-container" id="join-us-form">
          <div class="input-container group">
            <input type="email" name="floating_email" id="floating_email" class="peer" placeholder="" required />
          ...
          <div class="input-grid">
            <div class="input-container group">
              <input type="text" name="floating_first_name" id="floating_first_name" class="peer" placeholder="" required />
            ...
            <div class="input-container group">
              <input type="text" name="floating_last_name" id="floating_last_name" class="peer" placeholder="" required />
          ...
          <div class="input-grid">
          <div class="input-container group">
              <input type="tel" pattern="[0-9]{2}-[0-9]{3}-[0-9]{4}" name="floating_phone" id="floating_phone" class="peer" placeholder="" required />
              <label for="floating_phone" class="peer-focus:font-medium peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-red-600 peer-focus:dark:text-red-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0  peer-focus:scale-75 peer-focus:-translate-y-6">ID Code [0-9]{2}-[0-9]{3}-[0-9]{4}</label>
            </div>

            <div class="input-container group">
              <input type="text" name="floating_augmentation" id="floating_augmentation" class="peer" placeholder="" required />
          ...
          <button type="submit" class="glitch-button" data-text="SUBMIT">Submit</button>
        </form>
